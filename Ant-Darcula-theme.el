...
;;; Ant-Darcula-theme.el --- Emacs theme with a dark background.

;; Copyright (C) 2014 , MissingNoIOI

;; Author: MissingNoIOI
;; https://github.com/MissingNoIOI/emacs-ant-darcula
;; Version: 0.1
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number ((t (:foreground ,fg1 :background ,bg1))))
   `(line-number-current-line ((t (:foreground ,fg1 :background ,bg2))))))
...
(provide-theme 'Ant-Darcula)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; Ant-Darcula-theme.el ends here
